...
С помощью этого софта микроконтроллер может управлять нагрузкой посредством дискретного сигнала (ВКЛ./ВЫКЛ.)
...
- **24.06.2024** - релиз версии 1.3 со следующими важными изменениями:
