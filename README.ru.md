...
- **24.05.2024** - релиз версии 1.3.6. Исправлены разного рода мелкие баги, обновлён веб-интерфейс.
...
3. Заменить текстовое поле ввода значения, управляющего скважностью сигнала ШИМ, на созданный
   с помощью фронтендового JavaScript ползунок.
