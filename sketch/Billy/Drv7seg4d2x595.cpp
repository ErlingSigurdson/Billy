...
Drv7seg4d2x595Class Drv7seg4d2x595;
...
Drv7seg4d2x595Class::Drv7seg4d2x595Class()
{
}
...
void Drv7seg4d2x595Class::init_bb(uint32_t data_pin, uint32_t latch_pin, uint32_t clock_pin, \
...
void Drv7seg4d2x595Class::init_spi(uint32_t mosi_pin, uint32_t latch_pin, uint32_t sck_pin, \
                                uint32_t ghosting_prevention_delay)
{
...
void Drv7seg4d2x595Class::init_spi(uint32_t latch_pin, uint32_t ghosting_prevention_delay)
{
    this->variant = DRV7SEG4D2X595_VARIANT_SPI;
    this->latch_pin = latch_pin;
    this->ghosting_prevention_delay = ghosting_prevention_delay;
...
void Drv7seg4d2x595Class::shift_out(uint8_t ubyte, uint8_t lbyte)
{
    switch (this->variant) {
