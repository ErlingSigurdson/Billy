...
namespace cmd {
    ...
    namespace handler {
         ...
         */
        void set_load_PWM(const char *cmd, uint32_t pin);
         ...
         * stored in an inbuilt storage.
         */
        void output_BTClassic_dev_name();
